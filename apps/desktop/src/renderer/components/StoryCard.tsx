  ...
  return (
    <article className="rounded-lg bg-neutral-900 border border-neutral-800 p-4 space-y-3">
      <header className="flex items-start gap-3">
        ...
        {runtime.status === 'running' && onStop && (
          <button
            onClick={onStop}
            className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 border border-rose-500/30"
          >
            Stop
          </button>
        )}
