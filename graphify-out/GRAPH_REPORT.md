...
- `slugify()` --calls--> `executeStory()`  [INFERRED]
  libs/orchestrator/src/slug.ts → /Users/zibby/Workspace/Zibby-2.0/libs/orchestrator/src/execute-story.ts
...
- `gitPush()` --calls--> `executeStory()`  [INFERRED]
  /Users/zibby/Workspace/Zibby-2.0/.worktrees/1-zobrazeni-usage/libs/github/src/index.ts → /Users/zibby/Workspace/Zibby-2.0/libs/orchestrator/src/execute-story.ts
