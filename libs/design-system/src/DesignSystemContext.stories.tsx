...
const stack: CSSProperties = { display: 'flex', flexDirection: 'column', gap: 16, width: 'min(620px, 90vw)' };
    ...
    <div style={stack}>
      ...
      <div>
        ...
        <DesignSystemProvider
          tokens={{
            status: {
              running: { color: 'var(--violet)', bg: 'rgba(167,139,250,.15)', dot: 'var(--violet)' },
            },
            chip: {
              accent: { color: 'var(--sky)', bg: 'rgba(56,189,248,.10)', border: 'rgba(56,189,248,.25)' },
            },
          }}
        >
          <Card>
            <CardHeader title="With override" subtitle="running → violet, accent chip → sky" />
            <CardContent>
              <div style={row}>
                <Badge status="running" />
                <Badge status="pushing" />
